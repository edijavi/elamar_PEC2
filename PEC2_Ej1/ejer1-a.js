const findOne = (list, { key, value }, { onSuccess, onError }) => {
  ...
  */
    ...
    */
    ...
    /*
    Sentencia If/Else, Si se ecuantra un elemento dentro del array se llama a la función onSuccess y se le pasa el parámetro const element
    Si no se encuentra el elemento en el array se llama a la función onError se le pasa un objeto como parámentro,
